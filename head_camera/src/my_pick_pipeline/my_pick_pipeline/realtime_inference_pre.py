...
# ===== 配置 =====
MODEL_PATH = "/home/zyy/task/arm/head_camera/src/squarebest.pt"
CONFIDENCE = 0.45
IOU = 0.5
# DEVICE=0
...
CAMERA_SERIAL = "043322075459"  # 填入相机序列号，如 "987654321"；留空则自动选第一个
MASK_THRESH = 0.5
EXPECTED_SIDE_M = 0.4
...
def main(args=None):
    ...
    try:
        while rclpy.ok():
            ...
            if mask_u8 is not None:
                ...
                if pts3d is not None:
                    ...
                    if plane is not None:
                        ...
                        center_3d, _ = estimator.compute_center_from_corner_count(corners_3d, origin, axis_u, axis_v, mask_centroid_uv)
            ...
            cv2.imshow("head_camera: Mask Visible Right-Angle Corners", vis)
